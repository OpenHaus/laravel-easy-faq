...
namespace OpenHaus\LaravelEasyFaq\Facades;

use OpenHaus\LaravelEasyFaq\FaqManager;
use Illuminate\Support\Facades\Facade;

/**
 * Faq facade - allows easy access to the Manager instance.
 *
