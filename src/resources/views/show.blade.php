            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="media blog-post-author">
                        <img alt="Image" src="{{ asset('images1/fabio_bacigalupo_presse_klein.jpg') }}" class="avatar avatar-sm mr-3" />
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-12 col-md-8 col-lg-7">
                    ...
                    @guest
                        <div class="mt-5">
                            <a class="btn btn-info" href="{{route('packages')}}">Probiere jetzt podcaster.de kostenlos fü 30 Tage aus!</a>
                        </div>
                    @endguest
                </div>
                <!--end of col-->
                            ...
                            <ul class="list-unstyled list-spacing-sm">
                                @foreach($aFaq as $oFaq)
                                    <li>
                                        ...
                                        <a href="{{ route('faq.show', ['id' => $oFaq->faq_id, 'slug' => Str::slug($oFaq->question)]) }}">{{ $oFaq->question }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
